...
#import "InfoDengueSubVC4Symptoms.h"
#import "LocalizedText.h"
#import "GlobalVariableAndMethod.h"

@interface InfoDengueSubVC4Symptoms ()
...
//Showing texts related to dengue-symptoms in different languages
@implementation InfoDengueSubVC4Symptoms
...
-(void)setLanguageText {
    ...
    [[UILabel appearanceWhenContainedInInstancesOfClasses:[NSArray arrayWithObject:[InfoDengueSubVC4Symptoms class]]] setFont:[UIFont fontWithName:userFontType size:userFontSize]];
    
    //Set label texts
    self.lablUTitle1.text = [LocalizedText translateTextByTextIdentifier:@"dengue_symptoms_title1" byLanguageCode:userLanguageCode];
    self.lablUTitle1Para1.text = [LocalizedText translateTextByTextIdentifier:@"dengue_symptoms_para1" byLanguageCode:userLanguageCode];
    self.lablUTitle1Para2.text = [LocalizedText translateTextByTextIdentifier:@"dengue_symptoms_para2" byLanguageCode:userLanguageCode];
    self.lablUTitle1Para3.text = [LocalizedText translateTextByTextIdentifier:@"dengue_symptoms_para3" byLanguageCode:userLanguageCode];
    self.lablUTitle1Para4.text = [LocalizedText translateTextByTextIdentifier:@"dengue_symptoms_para4" byLanguageCode:userLanguageCode];
    self.lablUTitle1Para5.text = [LocalizedText translateTextByTextIdentifier:@"dengue_symptoms_para5" byLanguageCode:userLanguageCode];
    self.lablUTitle1Para6.text = [LocalizedText translateTextByTextIdentifier:@"dengue_symptoms_para6" byLanguageCode:userLanguageCode];
    self.lablUTitle1Para7.text = [LocalizedText translateTextByTextIdentifier:@"dengue_symptoms_para7" byLanguageCode:userLanguageCode];
