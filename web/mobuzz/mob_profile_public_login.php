...
function get_data($user, $password, $imei, $mobile, $uudid, $time_stamp) {
    ...
    if (mysqli_connect_errno()) {
        close_db($mysqli);
        return LOGIN_DB_ERROR_CONN_JSON;
    }
    ...
    $sql2 = "UPDATE public_users SET sim_serial_no = '$imei', device_sim_no = '$mobile', device_udid = '$uudid', time_stamp = '$time_stamp', last_server_login = $nowtimestamp WHERE username = '$user'";
